...
export default class Ranking_analytics extends Component {
    render() {
        return ( 
            <div>          
                <MDBContainer>
                      ...
                      <MDBRow>
                        <MDBCol md='4' style={{marginTop:'20px'}}>
                          <div className='ranking_analytics_contant1'>Google Local Average Ranking</div>
                        </MDBCol>
                        <MDBCol md='2' >
                        ...
                        <select id='ranking_ketword_btn' >
                            <option selected value="Add new keyword" >Add new keyword</option>
...
<div className='ranking_analytics_contant3'>
  <span><img src={left_arrow} alt=''/> </span>
<span className='ranking_icon'>00</span>
<span><img src={right_arrow} alt='' /> </span>
</div>

<div className='ranking_analytics_contant4'>Ranking  1-3 </div>
  </div>
</MDBCol>
<MDBCol md='6'>
<div className='review_container'>
...
<div className='ranking_analytics_contant4'>Ranking  4-10 </div>
  </div>
</MDBCol>
</MDBRow>
<MDBRow>
...
<div className='ranking_analytics_contant3'>
<span className='ranking_icon'>00</span>
<span><img src={up_arrow} alt=''/> </span>
</div>
<div className='ranking_analytics_contant4'>Ranking  11-25 </div>
  </div>
</MDBCol>
<MDBCol md='6'>
<div className='review_container'>
...
<div className='ranking_analytics_contant4'>Ranking  26-50 </div>
  </div>
</MDBCol>
</MDBRow>
                        </MDBCol>
           ...
           <MDBRow>
             <MDBCol md='3'>
               <div className='review_container'>
<div><img src={ranking_analytics_img1 } className='ranking_analytics_img'/> </div>
<div className='ranking_analytics_contant5'>03</div>
<div className='ranking_analytics_contant6'>Rising Keywords</div>
<div className='ranking_analytics_contant7'>Keyword that have moved up in the rank</div>
               </div>
             </MDBCol>

             <MDBCol md='3'>
               <div className='review_container'>
               <div><img src={ranking_analytics_img2 } className='ranking_analytics_img'/> </div>
<div className='ranking_analytics_contant5'>07</div>
<div className='ranking_analytics_contant6'>Declining Keywords</div>
<div className='ranking_analytics_contant7'>Keyword that have moved up in the rank</div>
               </div>
             </MDBCol>
             ...
             <MDBCol md='3'>
               <div className='review_container'>
               <div><img src={ranking_analytics_img3 } className='ranking_analytics_img'/> </div>
...
<div className='ranking_analytics_contant7'>Keyword that have moved up in the rank</div>
             ...
             <MDBCol md='3'>
               <div className='review_container'>
               <div><img src={ranking_analytics_img4 } className='ranking_analytics_img'/> </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className='table_col1'>
                        <span >41</span>
                        <span className='table_col2'>5 <img src={up_arrow} alt=''/></span>
                      </div>
                    </td>
                    <td><div className='table_col1'>No Match</div></td>
                    <td><div className='table_col1'>No Match</div></td>
                    <td><div className='table_col1'>No Match</div></td>
                  </tr>
                  <tr>
