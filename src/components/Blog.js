...
export default class Blog extends Component {
    render() {
        return (
            <div>
                <div>
                <div id='blog_heading1' >
                Our Blogs
                </div>
                <div className='blog_contant' id='blog_contant0'>
                    <p>
                ...
                <div>
                    ...
                    <img src={arrow} alt='arrow' id='blog_arrow'/>
                </div>
                
                <img src={line} alt='line' id='blog_hr1'/>
                <div>
                <div id='blog_container1'/>
                        <img src={blog1} alt='blog1' id='blog1'/>
                        <div className='sub_blog_heading' id='sub_blog_heading1'>
                          Google’s Latest API Update: Specify Service Items for Your Business
                          </div>
                          <div id='blog_contant1' className='blog_contant'>
                          On April 27th 2020, Google launched version 4.6 of its Google My Business (GMB) API for... 
                          </div>
                            
                    <div>
                    <div id='blog_container2'/> 
                        <div><img src={blog2} alt='blog2' id='blog2'/> </div>
                        <div className='sub_blog_heading' id='sub_blog_heading2'> 4 Reasons Search Is the Most Critical Issue</div>
                        <div id='blog_contant2' className='blog_contant'> With 90% of consumers reporting that they use search at every stage of the customer lifecycle...</div>
                        </div>
