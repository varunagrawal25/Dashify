...
<MDBBtn className='scanner_btn'>39</MDBBtn>
            ...
            <MDBDataTableV5 hover entriesOptions={[5, 20, 25]} entries={5} pagesAmount={4} data={datatable} />
                ...
                <div>
                <MDBRow>
                  <MDBCol md='2' className='scanner_table_heading col-md-offset-4'>
                    <div >Bussiness Name</div>
                  </MDBCol>
                  <MDBCol md='2' className='scanner_table_heading '>
                    <div >Bussiness Name</div>
                  </MDBCol>
                  <MDBCol md='2' className='scanner_table_heading '>
                    <div >Bussiness Name</div>
                ...
                <hr className='scanner_hr' id='scanner_hr1' className='scanner_hr'/>
                <MDBRow>
                  <MDBCol md='1'>
                ...
                <hr className='scanner_hr' className='scanner_hr'/>
                ...
                <MDBRow>
                  <MDBCol className='col-md-offset-10' md='2'>
                  <div>
                    <span id='scanner_contant8'>See all results</span>
                    <span ><img src={require("../assets/arrow.png")} /></span>
                  </div>
                  </MDBCol>
                </MDBRow>
